[![Build Status](https://dev.azure.com/lfs-sparky/terraform-test/_apis/build/status/zhaonotes.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/lfs-sparky/terraform-test/_build/latest?definitionId=8&branchName=master)
